...
import com.sandesh.jersey.exceptions.DataNotFoundException;
...
public class MessageService {
	...
	public MessageService() {
		messages.put(1L, new Message(1, "Hello World", "Sandesh"));
		messages.put(2L, new Message(2, "Hello Jersey", "Sandesh"));
	}
